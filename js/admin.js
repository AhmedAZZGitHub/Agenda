...
import { database, auth, ref, get, set, remove, onValue, sendPasswordResetEmail } from "./firebase-config.js?v=15.2";
import { state, showLoading, hideLoading } from "./state.js?v=15.2";
