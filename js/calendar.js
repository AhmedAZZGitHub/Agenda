...
import { database, ref, set, remove, update } from "./firebase-config.js?v=15.8";
import {
  state,
  getStudentPath,
  getMon,
  ...
  hideLoading,
  playBeep,
} from "./state.js?v=15.8";
import { renderDetailSessionMap, initEditPickerMap } from "./maps.js?v=15.8";
