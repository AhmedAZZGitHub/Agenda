...
import { database, ref, set, get, remove, update } from "./firebase-config.js?v=18.0";
import {
  state,
  getStudentPath,
  getMon,
  ...
  showLoading,
  hideLoading,
} from "./state.js?v=18.0";
import { renderDetailSessionMap, initEditPickerMap } from "./maps.js?v=18.0";
