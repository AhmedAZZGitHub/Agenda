...
import {
  ...
  onValue,
  off,
} from "./firebase-config.js?v=15.2";
import { state, getStudentPath, showLoading, hideLoading } from "./state.js?v=15.2";
import { loadAdminKPIs, listenToAnnouncements } from "./admin.js?v=15.2";
import { render } from "./calendar.js?v=15.2";
import { switchTrimester, selectBacSubject } from "./grades.js?v=15.2";
